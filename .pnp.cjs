...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "dependencyTreeRoots": [\
      ...
      {\
        "name": "@igbot/resources",\
        "reference": "workspace:src/resources"\
      },\
      {\
        "name": "@igbot/website",\
        "reference": "workspace:src/website"\
      },\
      {\
        "name": "@igbot/core-tests",\
        "reference": "workspace:tests/core"\
      }\
    ],\
    "enableTopLevelFallback": true,\
    "ignorePatternData": "(^(?:\\\\.yarn\\\\/sdks(?:\\\\/(?!\\\\.{1,2}(?:\\\\/|$))(?:(?:(?!(?:^|\\\\/)\\\\.{1,2}(?:\\\\/|$)).)*?)|$))$)",\
    "fallbackExclusionList": [\
      ["@igbot/api", ["workspace:src/api"]],\
      ["@igbot/cluster", ["workspace:src/cluster"]],\
      ["@igbot/core", ["workspace:src/core"]],\
      ["@igbot/core-tests", ["workspace:tests/core"]],\
      ["@igbot/master", ["workspace:src/master"]],\
      ["@igbot/resources", ["workspace:src/resources"]],\
      ["@igbot/website", ["workspace:src/website"]],\
      ["igbot", ["workspace:."]]\
    ],\
    "fallbackPool": [\
    ],\
    "packageRegistryData": [\
      ...
      ["@igbot/core-tests", [\
        ["workspace:tests/core", {\
          "packageLocation": "./tests/core/",\
          "packageDependencies": [\
            ["@igbot/core-tests", "workspace:tests/core"]\
          ],\
          "linkType": "SOFT"\
      ...
      ["@igbot/website", [\
        ["workspace:src/website", {\
          "packageLocation": "./src/website/",\
          "packageDependencies": [\
            ["@igbot/website", "workspace:src/website"]\
          ],\
          "linkType": "SOFT"\
